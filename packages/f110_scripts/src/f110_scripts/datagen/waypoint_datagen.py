...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Planner to use for navigation.",
    )
    ...
    parser.add_argument(
        ...
        help="Standard deviation of Gaussian noise added to steering (radians).",
    )
    ...
    parser.add_argument(
        ...
        help="Probability per step of injecting a steering drift/perturbation.",
    )
    ...
    parser.add_argument(
        ...
        help="Magnitude of the steering drift bias.",
    )
    ...
    parser.add_argument(
        ...
        help="Range [min, max] for randomized lookahead distance.",
    )
